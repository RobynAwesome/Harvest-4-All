...
[![Tailwind](https://img.shields.io/badge/Tailwind-06B67F?logo=tailwind-css&logoColor=white)](https://tailwindcss.com)
...
- **⭐ My Impact Dashboard** – Live personal stats, charts & achievements (the hackathon winner feature)
...
## 📸 Screenshots
*(Add your actual screenshots here — Home, Quiz, Dashboard, Marketplace)*
...
```bash
# 1. Clone the repo
git clone https://github.com/your-username/harvest-for-all.git
cd harvest-for-all
