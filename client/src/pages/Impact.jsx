...
const Impact = () => {
  const { waterSaved } = useAppContext();
    ...
    datasets: [
      {
        fill: true,
        label: "Savings (ZAR)",
        data: [120, 450, 380, 800, 1200, 1650], // Base data + mapped real data would go here
        borderColor: "#166534",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          <div className="flex items-center justify-center py-24">
            <Loader2 className="w-12 h-12 text-[#166534] animate-spin" />
          </div>
        ) : (
              ...
              <div className="bg-white p-8 rounded-3xl border border-[#166534]/10">
                ...
                <div className="space-y-4">
                  {impactHistory.map((h, i) => (
                    <div
                      key={i}
                      className="flex justify-between items-center border-b border-[#f5f5f4] pb-4"
                    >
                      <div>
