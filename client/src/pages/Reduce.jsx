    ...
    <section className="section-fade py-16 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          ...
          <p className="text-[#111827]/60">Find local recycling points and learn upcycling techniques.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="lg:col-span-2 bg-white p-4 rounded-3xl shadow-lg border border-[#166534]/10 h-[500px] overflow-hidden">
            <MapContainer center={[-34.00, 18.60]} zoom={11} style={{ height: '100%', width: '100%', borderRadius: '1.5rem' }}>
          ...
          <div className="space-y-6">
            <div className="bg-[#166534] text-white p-8 rounded-3xl shadow-xl">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="font-bold text-xl uppercase tracking-tighter">DIY Upcycling</h3>
              </div>
              <ul className="space-y-4">
                <li className="p-4 bg-white/10 rounded-2xl">
                    <h4 className="font-bold text-sm mb-1">Plastic Bottle Planters</h4>
                    <p className="text-xs text-white/70">Cut 2L bottles into colorful hanging pots for spring onions.</p>
                </li>
                <li className="p-4 bg-white/10 rounded-2xl">
                    <h4 className="font-bold text-sm mb-1">Egg Carton Seedlings</h4>
                    <p className="text-xs text-white/70">Perfect biodegradable starter pots for your spinach seeds.</p>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl border border-[#166534]/10">
                ...
                <div className="space-y-4">
                    {points.map(p => (
                        <div key={p.id} className="flex items-start gap-4 p-3 hover:bg-[#f5f5f4] rounded-xl transition-colors cursor-pointer">
                            <MapPin className="w-5 h-5 text-[#166534] mt-1" />
                            <div>
                                <div className="font-bold text-sm">{p.name}</div>
                                <div className="text-xs text-[#111827]/40">2.4km • Open until 17:00</div>
                            </div>
                        </div>
                    ))}
                </div>
